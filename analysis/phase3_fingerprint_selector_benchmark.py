# -*- coding: utf-8 -*-
"""
Benchmark a task-fingerprint-driven regime selector against hardcoded regime switching and prior selector baselines.
"""
...
TARGET_JSON = resolve_canonical_results_path("phase3_fingerprint_selector_benchmark.json")
TARGET_MD = PROJECT_ROOT / "PHASE3_FINGERPRINT_SELECTOR_BENCHMARK.md"
...
def run_benchmark() -> Dict:
    payload = run_policy_benchmark_family(
        ...
        result_prefix="phase3_fingerprint_selector",
        title="Phase 3 Fingerprint Selector Benchmark",
        config_overrides={
...
def main() -> None:
    ...
    print(f"Saved fingerprint selector benchmark JSON: {TARGET_JSON}")
    print(f"Saved fingerprint selector benchmark markdown: {TARGET_MD}")
