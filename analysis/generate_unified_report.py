...
CANONICAL_RESULT_FILES = {
    ...
    "phase3_dynamics_selector_benchmark": "phase3_dynamics_selector_benchmark.json",
    "phase3_task_ranking_selector_benchmark": "phase3_task_ranking_selector_benchmark.json",
    "phase3_two_stage_selector_benchmark": "phase3_two_stage_selector_benchmark.json",
    "phase3_guarded_expert_selector_benchmark": "phase3_guarded_expert_selector_benchmark.json",
    "phase3_guarded_expert_simplification_benchmark": "phase3_guarded_expert_simplification_benchmark.json",
...
def render_markdown(summary: Dict) -> str:
    ...
    phase3_dynamics_selector_benchmark = summary["phase3_dynamics_selector_benchmark"]
    phase3_task_ranking_selector_benchmark = summary["phase3_task_ranking_selector_benchmark"]
    phase3_two_stage_selector_benchmark = summary["phase3_two_stage_selector_benchmark"]
    phase3_guarded_expert_selector_benchmark = summary["phase3_guarded_expert_selector_benchmark"]
    phase3_guarded_expert_simplification_benchmark = summary["phase3_guarded_expert_simplification_benchmark"]
    ...
    lines = [
        ...
        f"- Richer dynamics-selector check: `task_specialist_clone_dynamics_selector_merge` reaches mean avg delta {phase3_dynamics_selector_benchmark['aggregate']['task_specialist_clone_dynamics_selector_merge']['mean_avg_accuracy_delta_vs_adapt_only']:+.1%} vs `adapt_only` and mean gain vs fixed {phase3_dynamics_selector_benchmark['aggregate']['task_specialist_clone_dynamics_selector_merge']['mean_avg_accuracy_gain_vs_fixed']:+.1%} on `selector_full_map`.",
        f"- Stronger selector benchmark: `task_specialist_clone_task_ranking_selector_merge` reaches mean avg delta {phase3_task_ranking_selector_benchmark['aggregate']['task_specialist_clone_task_ranking_selector_merge']['mean_avg_accuracy_delta_vs_adapt_only']:+.1%} vs `adapt_only` and mean gain vs fixed {phase3_task_ranking_selector_benchmark['aggregate']['task_specialist_clone_task_ranking_selector_merge']['mean_avg_accuracy_gain_vs_fixed']:+.1%} on `selector_full_map`.",
        f"- Current selector frontier: `task_specialist_clone_two_stage_selector_merge` reaches mean avg delta {phase3_two_stage_selector_benchmark['aggregate']['task_specialist_clone_two_stage_selector_merge']['mean_avg_accuracy_delta_vs_adapt_only']:+.1%} vs `adapt_only`, mean gain vs fixed {phase3_two_stage_selector_benchmark['aggregate']['task_specialist_clone_two_stage_selector_merge']['mean_avg_accuracy_gain_vs_fixed']:+.1%}, and stays at {phase3_two_stage_selector_benchmark['aggregate']['task_specialist_clone_two_stage_selector_merge']['benchmark_wins']} benchmark wins on `selector_full_map`.",
        f"- Guarded-expert selector check: `task_specialist_clone_guarded_expert_selector_merge` reaches mean avg delta {phase3_guarded_expert_selector_benchmark['aggregate']['task_specialist_clone_guarded_expert_selector_merge']['mean_avg_accuracy_delta_vs_adapt_only']:+.1%} vs `adapt_only` and mean gain vs fixed {phase3_guarded_expert_selector_benchmark['aggregate']['task_specialist_clone_guarded_expert_selector_merge']['mean_avg_accuracy_gain_vs_fixed']:+.1%}; it matches `two_stage_selector` on the two key adversarial gates while trailing only slightly on aggregate tail metrics.",
        f"- Guarded-expert simplification check: hardcoding the default region back to boost drops to mean avg delta {phase3_guarded_expert_simplification_benchmark['aggregate']['task_specialist_clone_guarded_expert_boost_default_merge']['mean_avg_accuracy_delta_vs_adapt_only']:+.1%} and mean gain vs fixed {phase3_guarded_expert_simplification_benchmark['aggregate']['task_specialist_clone_guarded_expert_boost_default_merge']['mean_avg_accuracy_gain_vs_fixed']:+.1%}; hardcoding it to interference control drops further to {phase3_guarded_expert_simplification_benchmark['aggregate']['task_specialist_clone_guarded_expert_merge_default_merge']['mean_avg_accuracy_delta_vs_adapt_only']:+.1%} / {phase3_guarded_expert_simplification_benchmark['aggregate']['task_specialist_clone_guarded_expert_merge_default_merge']['mean_avg_accuracy_gain_vs_fixed']:+.1%}.",
