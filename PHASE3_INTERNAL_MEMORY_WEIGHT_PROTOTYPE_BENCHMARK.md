...
- `weight_prototype_2` (budget `2`, mode `weight_prototype`): mean avg delta vs `adapt_only` +11.8%, mean current delta +32.0%, mean forgetting delta -13.7%, mean gain vs fixed -5.6%, mean delta vs full budget -1.5%
...
- `weight_prototype_2`: avg delta vs `adapt_only` +10.6%, current delta +25.6%, forgetting delta -14.9%, gain vs fixed -6.2%
...
- `weight_prototype_2`: avg delta vs `adapt_only` +9.8%, current delta +20.8%, forgetting delta -11.2%, gain vs fixed -11.3%
...
- `weight_prototype_2`: avg delta vs `adapt_only` +14.9%, current delta +49.8%, forgetting delta -15.0%, gain vs fixed +0.8%
