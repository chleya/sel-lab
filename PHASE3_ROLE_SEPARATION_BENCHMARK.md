...
- `task_specialist_clone_role_separation_merge`: mean avg delta +4.9%, mean forgetting delta -3.9%, mean gain vs fixed -12.4%, suite wins 0

## Suite Winners

| Task Suite | Best Policy | limited_merge | distill_merge | role_separation_merge |
|---|---|---:|---:|---:|
| digits_pairs | task_specialist_clone_distill_merge | +5.3% | +5.4% | +5.1% |
| digits_pairs_noisy | task_specialist_clone_limited_merge | +3.5% | +3.4% | +3.4% |
| digits_pairs_permuted | task_specialist_clone_limited_merge | +6.3% | +6.0% | +6.3% |
