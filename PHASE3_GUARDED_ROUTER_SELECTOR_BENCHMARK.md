...
- `embedded`: samples=30, mean utility=-0.008, bias=+6.138
...
- `task_specialist_clone_guarded_router_selector_merge`: mean avg delta +4.2%, current delta +11.7%, prior delta +1.8%, forgetting delta -4.9%, gain vs fixed +5.2%, wins 0
