...
- `coverage_2` (budget `2`, mode `coverage`): mean avg delta vs `adapt_only` +11.8%, mean current delta +32.2%, mean forgetting delta -13.7%, mean gain vs fixed -5.6%, mean delta vs full budget -1.6%
...
- `coverage_2`: avg delta vs `adapt_only` +10.6%, current delta +25.8%, forgetting delta -14.9%, gain vs fixed -6.2%
...
- `coverage_2`: avg delta vs `adapt_only` +9.8%, current delta +20.9%, forgetting delta -11.3%, gain vs fixed -11.3%
...
- `coverage_2`: avg delta vs `adapt_only` +15.0%, current delta +49.9%, forgetting delta -15.0%, gain vs fixed +0.9%
