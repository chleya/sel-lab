...
- `key_value_2` (budget `2`, mode `key_value`): mean avg delta vs `adapt_only` +11.8%, mean current delta +32.2%, mean forgetting delta -13.6%, mean gain vs fixed -5.5%, mean delta vs full budget -1.5%
...
- `key_value_2`: avg delta vs `adapt_only` +10.6%, current delta +25.6%, forgetting delta -14.7%, gain vs fixed -6.2%
...
- `key_value_2`: avg delta vs `adapt_only` +9.8%, current delta +20.9%, forgetting delta -11.2%, gain vs fixed -11.3%
...
- `key_value_2`: avg delta vs `adapt_only` +15.1%, current delta +50.0%, forgetting delta -14.9%, gain vs fixed +1.0%
