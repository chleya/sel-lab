...
- Fitted weights: conflict_score=+0.037, conflict_peak=-0.025, confidence=-0.005, input_abs_mean=+0.065, input_nonnegative_ratio=-0.272, input_zero_ratio=+0.401, loss_mean=-0.020, loss_delta=-0.028, conflict_delta=+0.005, confidence_delta=-0.004, bias=+0.089

## Outcome Supervision Targets

- `plasticity_stress` / `digits_pairs_noisy`: target margin -0.057
- `interference_stress` / `feature_shift`: target margin +0.031
- `interference_stress_strong` / `feature_shift_noisy`: target margin +0.051
- `retrieval_ambiguity_stress` / `digits_pairs_permuted`: target margin +0.028
...
- `task_specialist_clone_dynamics_selector_merge`: mean avg delta +1.7%, current delta +3.7%, prior delta +1.0%, forgetting delta -2.1%, gain vs fixed +2.7%, wins 0
- `task_specialist_clone_outcome_selector_merge`: mean avg delta +2.8%, current delta +5.9%, prior delta +1.8%, forgetting delta -3.0%, gain vs fixed +3.8%, wins 0
...
- `task_specialist_clone_dynamics_selector_merge`: avg delta +4.7%, current delta +6.7%, prior delta +4.1%, forgetting delta -2.3%, gain vs fixed -18.3%
- `task_specialist_clone_outcome_selector_merge`: avg delta +13.6%, current delta +24.0%, prior delta +10.1%, forgetting delta -9.7%, gain vs fixed -9.5%
...
- `task_specialist_clone_dynamics_selector_merge`: avg delta +6.4%, current delta +22.3%, prior delta +1.0%, forgetting delta -6.3%, gain vs fixed -6.0%
...
- `task_specialist_clone_dynamics_selector_merge`: avg delta +1.4%, current delta -1.3%, prior delta +2.3%, forgetting delta +2.0%, gain vs fixed +12.2%
- `task_specialist_clone_outcome_selector_merge`: avg delta +1.5%, current delta -1.0%, prior delta +2.3%, forgetting delta +2.0%, gain vs fixed +12.3%
...
- `task_specialist_clone_dynamics_selector_merge`: avg delta +2.8%, current delta +7.0%, prior delta +1.3%, forgetting delta -1.0%, gain vs fixed -0.6%
...
- `task_specialist_clone_dynamics_selector_merge`: avg delta -1.2%, current delta -1.3%, prior delta -1.2%, forgetting delta -5.8%, gain vs fixed -2.4%
