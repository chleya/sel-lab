...
- Shared tuned configuration: current-path boost `2.50`, route threshold `0.35`
...
- `task_specialist_clone_external_memory_routed_merge`: mean avg delta +10.7%, mean current delta +30.1%, mean forgetting delta -13.6%, mean gain vs fixed -6.7%, suite wins 0
